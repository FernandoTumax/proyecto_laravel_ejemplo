                                ...
                                <tbody id="users_table">
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            @endif
                                            <td class="hidden-sm hidden-xs hidden-md">{{$user->created_at->format(trans('messages.date-format'))}}</td>
                                            <td class="hidden-sm hidden-xs hidden-md">{{$user->updated_at->format(trans('messages.date-format'))}}</td>
                                            <td>
