...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'message'               => 'mensaje',
        'plate'                 => 'placa',
        'sections'              => 'compartimientos',
        'cap_gal'               => 'galones',
        'cap_inches'            => 'pulgadas',
        'last_service_date'     => 'última fecha de servicio',
        'today'                 => 'hoy',
        'identifier'            => 'DPI',
        'super_last_digital_reading'  => 'última lectura digital de super',
        'super_last_mechanic_reding' => 'última lectura mecánica de super',
        'super_last_money_reading'    => 'última lectura dinero de super',
        'vehicle_id'            => 'vehículo',
        'manifest_date'         => 'fecha',
        'pilot_id'              => 'piloto',
        'order'                 => 'orden',
        'manifest'              => 'manifiesto',
        'minifest_date'         => 'fecha',
        'commision_rate'        => 'tasa de comisión',
        'dob'                   => 'fecha de nacimiento',
        'start_date'            => 'inicio de labores',
        'license_expiration'    => 'expiración de licencia',
        'diesel_last_digital_reading'   => 'última lectura digital de diesel',
        'diesel_last_mechanic_reding'   => 'última lectura mecánica de diesel',
        'diesel_last_money_reading'     => 'última lectura dinero de diesel',
        'regular_last_digital_reading'  => 'última lectura digital de regular',
        'regular_last_mechanic_reding'  => 'última lectura mecánica de regular',
        'regular_last_money_reading'    => 'última lectura dinero de regular'
    ],
];
